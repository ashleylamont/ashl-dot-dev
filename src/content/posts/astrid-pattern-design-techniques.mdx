...
![A photo of an animated woman wearing a full set of armour, make of iridescent blue dragon scales.](../../assets/astrid-armour.png)
...
![A large double-bladed axe, made from prop materials](../../assets/axe.jpg)
...
![A screenshot of a 3d model of a pauldron](../../assets/pepakura.png)
...
![A photo of a vinyl cutter with a pen attached to it and a piece of paper with a shape drawn onto it.](../../assets/plotter.jpg)
...
![A photo of a piece of foam with a bunch of circles drawn on it](../../assets/funky-circles.jpg)
...
![A photo of a pauldron with iridescent scales made from foam](../../assets/scale-armour.png)
...
![A 3d model of a pauldron with scales on it](../../assets/scale-model.png)

![A screenshot of a shader node graph in blender](../../assets/scale-shader.png)
...
![A screenshot of a texture of a flattened pauldron with scales on it](../../assets/scale-texture.png)
...
![A screenshot of a geometry node graph in blender](../../assets/geometry-nodes.png)
This just calculates the distance from the current point to a second object.

![A screenshot of a 3d model of a pauldron with a bunch of lines on it](../../assets/geometry-mesh.png)
We can draw out lines like this for ares we want to skip.

![A screenshot of a material node graph in blender](../../assets/geometry-material.png)
...
![A screenshot of pepakura designer with a textured model, and pieces of the texture split apart on the right](../../assets/pepakura-textures.png)

![A screenshot of affinity designer with a bunch of pieces of the texture and a solid outline for cutting](../../assets/combined-laser-file.png)
...
![A photo of a piece of foam used for tuning the laser cutter, with a bunch of etchings marked into it](../../assets/laser-tuning.jpg)
...
![A photo of a laser cutter with a piece of foam inside it](../../assets/laser-cutter.jpg)
Wooo lasers! Finally!

Using a laser cutter means the resulting pieces are all super cleanly cut, way nicer than you can get by hand.

![A photo of a sample piece with scales cut into it](../../assets/laser-sample.jpg)
...
![A photo of a test piece of a laser-cut pauldron](../../assets/pauldron-lasers.jpg)
